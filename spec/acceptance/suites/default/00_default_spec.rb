...
describe 'crypto_policy class' do
  ...
  hosts.each do |host|
    ...
    # even though nothing crypto_policy manages exists yet. Real idempotence is covered
    ...
    context 'in noop mode from a clean state' do
      ...
      before(:context) do
        on(host, 'puppet resource package crypto-policies ensure=absent')
        on(host, 'puppet resource package crypto-policies-scripts ensure=absent')
      end
